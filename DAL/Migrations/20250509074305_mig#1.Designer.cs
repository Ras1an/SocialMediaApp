...
namespace WesalApi.Migrations
{
    ...
    [Migration("20250509074305_mig#1")]
    partial class mig1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wesal.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Wesal.Models.City", b =>
                {
            ...
            modelBuilder.Entity("Wesal.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("Wesal.Models.Country", b =>
                {
                    b.Property<int>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wesal.Models.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wesal.Models.Profile", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Wesal.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wesal.Models.City", b =>
                {
                    b.HasOne("Wesal.Models.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Wesal.Models.Comment", b =>
                {
                    b.HasOne("Wesal.Models.AppUser", "AppUser")
                        .WithMany("Comments")
                        .HasForeignKey("AppUserId")
                        .IsRequired();

                    b.HasOne("Wesal.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Wesal.Models.Profile", b =>
                {
                    ...
                    b.HasOne("Wesal.Models.City", "CityNavigation")
                        .WithMany("Profiles")
                        .HasForeignKey("CityId");

                    b.HasOne("Wesal.Models.Country", "CountryNavigation")
                        .WithMany("Profiles")
                        .HasForeignKey("CountryId");
